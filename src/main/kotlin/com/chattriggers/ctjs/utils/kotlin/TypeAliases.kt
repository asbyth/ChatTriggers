...
internal typealias MCClickEvent = net.minecraft.event.ClickEvent
internal typealias MCHoverEvent = net.minecraft.event.HoverEvent
...
//$$ internal typealias MCClickEvent = net.minecraft.util.text.event.ClickEvent
//$$ internal typealias MCHoverEvent = net.minecraft.util.text.event.HoverEvent
