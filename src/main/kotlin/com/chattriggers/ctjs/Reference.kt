...
import com.chattriggers.ctjs.commands.UserCommand
...
object Reference {
    ...
    fun loadCT(updateCheck: Boolean = false) {
        ...
        ClientCommandHandler.instance.commandSet.removeIf { it is UserCommand }
        ClientCommandHandler.instance.commandMap.entries.removeIf { it.value is UserCommand }
