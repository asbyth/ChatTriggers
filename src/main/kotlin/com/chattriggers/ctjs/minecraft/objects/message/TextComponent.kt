...
class TextComponent {
    ...
    private fun reInstance() {
        this.chatComponentText = StringTextComponent(
    ...
    private fun reInstanceClick() {
        ...
        this.chatComponentText.style.clickEvent = ClickEvent(
            ClickEvent.Action.getValueByCanonicalName(this.clickAction),
            if (this.formatted) ChatLib.addColor(this.clickValue) else this.clickValue
        )

        // this.chatComponentText.getStyling().chatClickEvent =
        //     TextClickEvent(
    ...
    private fun reInstanceHover() {
        ...
        this.chatComponentText.style.hoverEvent = HoverEvent(
