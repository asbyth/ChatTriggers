...
public class LookingAt {
    private static RayTraceResult mop;
    ...
    public static double getDistanceFromPlayer() {
        if (block != null) {
            ...
            return (double) entity.getDistance(MinecraftVars.getPlayer());
        } else {
            return -1d;
        }
    }
    ...
    public static String getBlockRegistryName() {
        ...
        String rn = block.getRegistryName().toString().replace("minecraft:", "");
    ...
    public static int getBlockLightLevel() {
        ...
        if (block.getLightValue(block.getDefaultState()) != 0) return block.getLightValue(block.getDefaultState());
    ...
    public static String getEntityTeamName() {
        ...
        return ((EntityLivingBase) entity).getTeam().getName();
    }
