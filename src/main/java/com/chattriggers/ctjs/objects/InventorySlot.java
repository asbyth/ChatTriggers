...
public class InventorySlot {
    ...
    public String getRegistryName() {
        if (this.isEmpty()) return null;
        return this.getItem().getItem().getRegistryName().toString().replace("minecraft:", "");
    }
    ...
    private ItemStack getItem() {
        if (this.isArmor) return MinecraftVars.getPlayer().inventory.armorInventory.get(this.id);
